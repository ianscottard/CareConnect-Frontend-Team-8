...
export default function ResetPasswordScreen({ navigation }: Props) {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity onPress={() => navigation.navigate('Login')} accessibilityRole="button" accessibilityLabel="Back">
      ...
      <View style={styles.content}>
        ...
        <TextInput
          ...
          placeholder="E-mail"
        />
        <TouchableOpacity style={styles.button} onPress={() => {}} accessibilityRole="button" accessibilityLabel="Send reset link">
...
const styles = StyleSheet.create({
  ...
  back: { color: '#000000', fontSize: 38, lineHeight: 38, marginBottom: 55 },
