  ...
  return (
    <View style={styles.root}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <TouchableOpacity style={styles.logout} onPress={() => navigation.replace('Login')} accessibilityRole="button"><Text style={styles.logoutText}>Log out</Text></TouchableOpacity>
      </ScrollView>
...
function Setting({label}:{label:string}) { return <TouchableOpacity style={styles.setting} onPress={() => {}} accessibilityRole="button"><Text style={styles.settingText}>{label}</Text><Ionicons name="chevron-forward" size={22} color="#2C67BA" /></TouchableOpacity>; }
